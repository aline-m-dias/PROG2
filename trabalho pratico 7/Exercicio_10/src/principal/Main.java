...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Qual operação deseja realizar: 1- div / 2- log10");
		int op= sc.nextInt();
		...
		/*se remover o tratamento de excessão ao executar o codigo o java exibe que
		 *  a excessão InvalidOperationException está acontecendo*/
